      ...
      <div className="p-6 pb-5 flex flex-col sm:flex-row items-start sm:items-center gap-5 border-b border-border/60">
        ...
        <div className="flex-1 space-y-1.5">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Badge className="bg-emerald-600">{getRoleLabel(teacher.status || "2")}</Badge>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm shadow-xs focus:ring-2 focus:ring-emerald-500"
            >
